...
categories: blog
img: xdebug.png
tags: [docker, xdebug, container, code, phpstorm, debug, php]
author: edison_jr
brief: Um guia de como executar o xdebug dentro de um container do docker passo-a-passo
---
...
![alt-text]({{site.baseurl}}/assets/img/posts/phpstorm_server.png)
